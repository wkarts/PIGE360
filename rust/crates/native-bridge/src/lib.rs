...
use pige360_fiscal_snapshot::verify as verify_snapshot;
...
use pige360_sync_engine::{apply_result, pending};
use serde::{Deserialize, Serialize};
use serde_json::Value;
use std::path::PathBuf;
use tauri::{AppHandle, Manager};

// Os adaptadores marcados com `#[tauri::command]` vivem no binário de cada
// aplicativo (`tauri_commands.rs`). O macro do Tauri gera símbolos no crate
// consumidor e não pode ser exportado com segurança por esta biblioteca.
pub use pige360_fiscal_snapshot::FiscalSnapshot;
pub use pige360_sync_engine::PushResult;
