...
out=root/'docs/execution/evidence/backend-regression-fiscal-routing-r000025.json'
progress=root/'docs/execution/evidence/backend-regression-fiscal-routing-r000025.progress'
...
summary=root/'docs/execution/evidence/backend-final-regression-fiscal-routing.log'
