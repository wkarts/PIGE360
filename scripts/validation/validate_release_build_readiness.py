...
def main() -> int:
    ...
    for required in ("tauri ios init --ci", "tauri.ios.conf.json", "restore_ios_platform_config", "CODE_SIGNING_ALLOWED=NO", "CODE_SIGNING_REQUIRED=NO", "rm -rf src-tauri/gen/apple", "Falha ao gerar o projeto iOS"):
