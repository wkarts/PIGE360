...
EXPECTED_WORKFLOWS={'00-ci.yml','05-pedagogy-attendance.yml','10-base-images.yml','20-application-images.yml','30-build-web.yml','31-build-desktop.yml','32-build-android.yml','33-build-ios.yml','34-build-tenant-apps.yml','40-security.yml','50-release.yml','60-deploy-saas.yml','61-self-hosted-bundle.yml','70-backup-restore-test.yml','80-dependency-maintenance.yml'}
